          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>You're in development mode. Clicking "Subscribe" will show a mock checkout dialog instead of real Stripe checkout. This allows you to test the billing flow without making actual payments.</p>
              </div>
            </div>
          </div>
        </div>
